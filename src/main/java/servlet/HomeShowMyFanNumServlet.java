...
@WebServlet("/HomeShowMyFanNumServlet")
public class HomeShowMyFanNumServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            //Home个人信息卡返回个人 粉丝数---DJN
            BigDecimal myuserid = new BigDecimal(request.getParameter("nowuserid"));
            ShowMyRelDao showMyRelDao = new ShowMyRelDaoImpl();
            List<ShowMyRel> showMyRels = showMyRelDao.ShowMyFunnum(myuserid);
